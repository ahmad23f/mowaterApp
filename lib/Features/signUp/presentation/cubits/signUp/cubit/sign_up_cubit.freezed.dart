...
abstract class _$$FaliureImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({String faliure});
}

/// @nodoc
class __$$FaliureImplCopyWithImpl<$Res>
    extends _$SignUpStateCopyWithImpl<$Res, _$FaliureImpl>
...
class _$FaliureImpl implements _Faliure {
  const _$FaliureImpl(this.faliure);
  ...
  @override
  String toString() {
    return 'SignUpState.faliure(faliure: $faliure)';
  }
...
abstract class _Faliure implements SignUpState {
  const factory _Faliure(final String faliure) = _$FaliureImpl;
